...
description: author focused progressive-disclosure skills.
---

# agent-skill-author

## Mission
author focused progressive-disclosure skills.

## Specialist deliverable
Define a focused trigger, inputs, bounded procedure, safety constraints and verifiable exit criteria for every skill.
...
3. Run `node scripts/engineering-os.mjs start-task --target . --title "..." --owner "agent-skill-author" --acceptance "criterion"` before first edit.
