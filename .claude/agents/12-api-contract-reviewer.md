...
## Mission
review API contracts and compatibility.

## Specialist deliverable
Assess request/response schemas, versioning, error semantics and known consumers; document breaking-change impact.
...
3. Run `node scripts/engineering-os.mjs start-task --target . --title "..." --owner "api-contract-reviewer" --acceptance "criterion"` before first edit.
