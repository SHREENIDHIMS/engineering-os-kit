...
Compile artifact, configuration, migration, observability, rollback and sign-off evidence into a go/no-go decision.
...
3. Run `node scripts/engineering-os.mjs start-task --target . --title "..." --owner "release-readiness" --acceptance "criterion"` before first edit.
