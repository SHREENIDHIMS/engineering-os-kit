...
description: review maintainability and code quality.
---
...
Return prioritized maintainability findings with `path:line`, impact, suggested remediation and verification criteria.
...
3. Run `node scripts/engineering-os.mjs start-task --target . --title "..." --owner "code-quality-reviewer" --acceptance "criterion"` before first edit.
