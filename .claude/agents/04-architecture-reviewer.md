...
description: review architecture and boundaries.
---
...
3. Run `node scripts/engineering-os.mjs start-task --target . --title "..." --owner "architecture-reviewer" --acceptance "criterion"` before first edit.
