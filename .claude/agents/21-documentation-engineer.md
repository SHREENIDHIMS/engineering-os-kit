...
description: keep documentation aligned.
---
...
Identify affected documentation, update usage examples, and verify claims against current code and behavior.
...
3. Run `node scripts/engineering-os.mjs start-task --target . --title "..." --owner "documentation-engineer" --acceptance "criterion"` before first edit.
