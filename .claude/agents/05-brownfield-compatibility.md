---
name: brownfield-compatibility
description: preserve brownfield compatibility.
---

# brownfield-compatibility

## Mission
preserve brownfield compatibility.
...
3. Run `node scripts/engineering-os.mjs start-task --target . --title "..." --owner "brownfield-compatibility" --acceptance "criterion"` before first edit.
