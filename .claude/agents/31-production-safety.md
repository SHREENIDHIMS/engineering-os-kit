...
description: check deployment/rollback safety.
---

# production-safety

## Mission
check deployment/rollback safety.

## Specialist deliverable
Define blast radius, monitoring, failure criteria, rollback trigger and approval gates before production changes.
...
3. Run `node scripts/engineering-os.mjs start-task --target . --title "..." --owner "production-safety" --acceptance "criterion"` before first edit.
