...
description: validate service/database/API boundaries.
---

# integration-test-specialist

## Mission
validate service/database/API boundaries.
...
3. Run `node scripts/engineering-os.mjs start-task --target . --title "..." --owner "integration-test-specialist" --acceptance "criterion"` before first edit.
