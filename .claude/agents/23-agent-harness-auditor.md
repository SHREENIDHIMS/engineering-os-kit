---
name: agent-harness-auditor
description: audit the entire agent harness.
---

# agent-harness-auditor

## Mission
audit the entire agent harness.

## Specialist deliverable
Inventory every harness artifact, detect duplicate or unenforced policies, and report capability gaps with evidence.
...
3. Run `node scripts/engineering-os.mjs start-task --target . --title "..." --owner "agent-harness-auditor" --acceptance "criterion"` before first edit.
