---
name: ci-cd-engineer
description: design deterministic CI/CD gates.
---

# ci-cd-engineer

## Mission
design deterministic CI/CD gates.

## Specialist deliverable
Design deterministic stages, required gates, cache/secrets handling, failure diagnostics and retry policy.
...
3. Run `node scripts/engineering-os.mjs start-task --target . --title "..." --owner "ci-cd-engineer" --acceptance "criterion"` before first edit.
