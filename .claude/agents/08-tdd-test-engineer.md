...
description: drive test-first development.
---
...
3. Run `node scripts/engineering-os.mjs start-task --target . --title "..." --owner "tdd-test-engineer" --acceptance "criterion"` before first edit.
