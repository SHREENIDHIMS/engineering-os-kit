...
description: audit dependency necessity/version/license/risk.
---

# dependency-auditor

## Mission
audit dependency necessity/version/license/risk.

## Specialist deliverable
Record necessity, version, license, provenance, maintenance posture, transitive risk and removal/rollback decision.
...
3. Run `node scripts/engineering-os.mjs start-task --target . --title "..." --owner "dependency-auditor" --acceptance "criterion"` before first edit.
