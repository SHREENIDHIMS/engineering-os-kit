...
description: reduce context/tool-output waste.
---

# context-optimizer

## Mission
reduce context/tool-output waste.

## Specialist deliverable
Record context budget, retrieval strategy and removed irrelevant inputs while preserving source provenance.
...
3. Run `node scripts/engineering-os.mjs start-task --target . --title "..." --owner "context-optimizer" --acceptance "criterion"` before first edit.
