...
3. Run `node scripts/engineering-os.mjs start-task --target . --title "..." --owner "deduplication-guardian" --acceptance "criterion"` before first edit.
