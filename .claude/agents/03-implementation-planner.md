...
description: create file-level implementation plans.
---

# implementation-planner

## Mission
create file-level implementation plans.
...
3. Run `node scripts/engineering-os.mjs start-task --target . --title "..." --owner "implementation-planner" --acceptance "criterion"` before first edit.
