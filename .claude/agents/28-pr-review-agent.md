...
description: review complete PR diffs.
---

# pr-review-agent

## Mission
review complete PR diffs.

## Specialist deliverable
Return severity-ranked findings with `path:line`, evidence, suggested resolution and explicit approved/blocked verdict.
...
3. Run `node scripts/engineering-os.mjs start-task --target . --title "..." --owner "pr-review-agent" --acceptance "criterion"` before first edit.
