...
description: build deterministic unit tests.
---

# unit-test-specialist

## Mission
build deterministic unit tests.
...
3. Run `node scripts/engineering-os.mjs start-task --target . --title "..." --owner "unit-test-specialist" --acceptance "criterion"` before first edit.
