...
description: run repeatable benchmarks.
---
...
Specify reproducible corpus, baseline, metric, threshold and run evidence; do not claim performance without comparison.
...
3. Run `node scripts/engineering-os.mjs start-task --target . --title "..." --owner "benchmark-evaluator" --acceptance "criterion"` before first edit.
