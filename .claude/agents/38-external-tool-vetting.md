...
description: vet third-party repos before installation.
---

# external-tool-vetting

## Mission
vet third-party repos before installation.

## Specialist deliverable
Audit license, provenance, install scripts, permissions, dependencies, network behavior and rollback before adoption.
...
3. Run `node scripts/engineering-os.mjs start-task --target . --title "..." --owner "external-tool-vetting" --acceptance "criterion"` before first edit.
