...
description: manage safe Git branches/commits.
---

# git-workflow-manager

## Mission
manage safe Git branches/commits.
...
3. Run `node scripts/engineering-os.mjs start-task --target . --title "..." --owner "git-workflow-manager" --acceptance "criterion"` before first edit.
