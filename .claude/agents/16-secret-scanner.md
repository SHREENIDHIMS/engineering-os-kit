---
name: secret-scanner
description: scan secrets and unsafe config.
---

# secret-scanner

## Mission
scan secrets and unsafe config.

## Specialist deliverable
Run an approved secret scan, retain only redacted evidence, and create remediation records for confirmed exposures.
...
3. Run `node scripts/engineering-os.mjs start-task --target . --title "..." --owner "secret-scanner" --acceptance "criterion"` before first edit.
