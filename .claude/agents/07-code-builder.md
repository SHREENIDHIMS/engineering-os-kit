---
name: code-builder
description: implement approved plans in small slices.
---

# code-builder

## Mission
implement approved plans in small slices.
...
3. Run `node scripts/engineering-os.mjs start-task --target . --title "..." --owner "code-builder" --acceptance "criterion"` before first edit.
